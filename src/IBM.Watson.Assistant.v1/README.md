[![NuGet](https://img.shields.io/badge/nuget-v2.16.0-green.svg?style=flat)](https://www.nuget.org/packages/IBM.Watson.Assistant.v1/)
...
PM > Install-Package IBM.Watson.Assistant.v1
...
<ItemGroup>
    <PackageReference Include="IBM.Watson.Assistant.v1" Version="2.16.0" />
</ItemGroup>
