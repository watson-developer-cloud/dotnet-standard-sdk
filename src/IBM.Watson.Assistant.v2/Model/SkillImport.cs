...
namespace IBM.Watson.Assistant.v2.Model
{
    ...
    public class SkillImport
    {
        ...
        ///  - **Processing**: An asynchronous operation has not yet completed.
        ///  - **Training**: The skill is training based on new data.
        /// Constants for possible values can be found using SkillImport.StatusEnumValue
        /// </summary>
        [JsonProperty("status", NullValueHandling = NullValueHandling.Ignore)]
        public string Status { get; set; }
        /// <summary>
        /// The type of skill.
        /// Constants for possible values can be found using SkillImport.TypeEnumValue
        /// </summary>
