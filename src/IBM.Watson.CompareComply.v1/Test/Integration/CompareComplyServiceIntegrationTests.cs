...
namespace IBM.Watson.CompareComply.v1.IntegrationTests
{
    ...
    public class CompareComplyServiceIntegrationTests
    {
        ...
        private string contractAFilePath = @"TestData/contract_A.pdf";
        private string contractBFilePath = @"TestData/contract_B.pdf";
        private string tableFilePath = @"TestData/TestTable.png";
