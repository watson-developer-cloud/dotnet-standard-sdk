...
namespace IBM.Watson.Discovery.v1.UnitTests
{
    ...
    public class DiscoveryServiceUnitTests
    {
        ...
        public void ConstructorNoUrl()
        {
            ...
            DiscoveryService service = Substitute.For<DiscoveryService>("testString", "test_service");
        ...
        public void TestTestListEnvironmentsAllParams()
        {
            ...
            var responseJson = "{'environments': [{'environment_id': 'EnvironmentId', 'name': 'Name', 'description': 'Description', 'created': '2019-01-01T12:00:00', 'updated': '2019-01-01T12:00:00', 'status': 'active', 'read_only': false, 'size': 'LT', 'requested_size': 'RequestedSize', 'index_capacity': {'documents': {'indexed': 7, 'maximum_allowed': 14}, 'disk_usage': {'used_bytes': 9, 'maximum_allowed_bytes': 19}, 'collections': {'available': 9, 'maximum_allowed': 14}}, 'search_status': {'scope': 'Scope', 'status': 'NO_DATA', 'status_description': 'StatusDescription', 'last_trained': '2019-01-01'}}]}";
        ...
        public void TestTestCreateConfigurationAllParams()
        {
            ...
            string name = "testString";
            string description = "testString";
            Conversions conversions = ConversionsModel;
            List<Enrichment> enrichments = new List<Enrichment> { EnrichmentModel };
            List<NormalizationOperation> normalizations = new List<NormalizationOperation> { NormalizationOperationModel };
        ...
        public void TestTestDeleteConfigurationAllParams()
        {
            ...
            var responseJson = "{'configuration_id': 'ConfigurationId', 'status': 'deleted', 'notices': [{'notice_id': 'NoticeId', 'created': '2019-01-01T12:00:00', 'document_id': 'DocumentId', 'query_id': 'QueryId', 'severity': 'warning', 'step': 'Step', 'description': 'Description'}]}";
        ...
        public void TestTestListCollectionsAllParams()
        {
            ...
            var responseJson = "{'collections': [{'collection_id': 'CollectionId', 'name': 'Name', 'description': 'Description', 'created': '2019-01-01T12:00:00', 'updated': '2019-01-01T12:00:00', 'status': 'active', 'configuration_id': 'ConfigurationId', 'language': 'Language', 'document_counts': {'available': 9, 'processing': 10, 'failed': 6, 'pending': 7}, 'disk_usage': {'used_bytes': 9}, 'training_status': {'total_examples': 13, 'available': false, 'processing': true, 'minimum_queries_added': false, 'minimum_examples_added': true, 'sufficient_label_diversity': true, 'notices': 7, 'successfully_trained': '2019-01-01T12:00:00', 'data_updated': '2019-01-01T12:00:00'}, 'crawl_status': {'source_crawl': {'status': 'running', 'next_crawl': '2019-01-01T12:00:00'}}, 'smart_document_understanding': {'enabled': false, 'total_annotated_pages': 19, 'total_pages': 10, 'total_documents': 14, 'custom_fields': {'defined': 7, 'maximum_allowed': 14}}}]}";
        ...
        public void TestTestCreateExpansionsAllParams()
        {
            ...
            string environmentId = "testString";
            string collectionId = "testString";
            List<Expansion> expansions = new List<Expansion> { ExpansionModel };
        ...
        public void TestTestCreateTokenizationDictionaryAllParams()
        {
            ...
            string environmentId = "testString";
            string collectionId = "testString";
            List<TokenDictRule> tokenizationRules = new List<TokenDictRule> { TokenDictRuleModel };
        ...
        public void TestTestAddDocumentAllParams()
        {
            ...
            var responseJson = "{'document_id': 'DocumentId', 'status': 'processing', 'notices': [{'notice_id': 'NoticeId', 'created': '2019-01-01T12:00:00', 'document_id': 'DocumentId', 'query_id': 'QueryId', 'severity': 'warning', 'step': 'Step', 'description': 'Description'}]}";
        ...
        public void TestTestGetDocumentStatusAllParams()
        {
            ...
            var responseJson = "{'document_id': 'DocumentId', 'configuration_id': 'ConfigurationId', 'status': 'available', 'status_description': 'StatusDescription', 'filename': 'Filename', 'file_type': 'pdf', 'sha1': 'Sha1', 'notices': [{'notice_id': 'NoticeId', 'created': '2019-01-01T12:00:00', 'document_id': 'DocumentId', 'query_id': 'QueryId', 'severity': 'warning', 'step': 'Step', 'description': 'Description'}]}";
        ...
        public void TestTestQueryAllParams()
        {
            ...
            var responseJson = "{'matching_results': 15, 'results': [{'id': 'Id', 'metadata': {'mapKey': 'unknown property type: Inner'}, 'collection_id': 'CollectionId', 'result_metadata': {'score': 5, 'confidence': 10}}], 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'passages': [{'document_id': 'DocumentId', 'passage_score': 12, 'passage_text': 'PassageText', 'start_offset': 11, 'end_offset': 9, 'field': 'Field'}], 'duplicates_removed': 17, 'session_token': 'SessionToken', 'retrieval_details': {'document_retrieval_strategy': 'untrained'}, 'suggested_query': 'SuggestedQuery'}";
            ...
            long? count = 38;
            string _return = "testString";
            long? offset = 38;
            string sort = "testString";
            bool? highlight = true;
            string passagesFields = "testString";
            long? passagesCount = 38;
            long? passagesCharacters = 38;
            bool? deduplicate = true;
            string deduplicateField = "testString";
            bool? similar = true;
            string similarDocumentIds = "testString";
            string similarFields = "testString";
            string bias = "testString";
        ...
        public void TestTestQueryNoticesAllParams()
        {
            ...
            var responseJson = "{'matching_results': 15, 'results': [{'id': 'Id', 'metadata': {'mapKey': 'unknown property type: Inner'}, 'collection_id': 'CollectionId', 'result_metadata': {'score': 5, 'confidence': 10}, 'code': 4, 'filename': 'Filename', 'file_type': 'pdf', 'sha1': 'Sha1', 'notices': [{'notice_id': 'NoticeId', 'created': '2019-01-01T12:00:00', 'document_id': 'DocumentId', 'query_id': 'QueryId', 'severity': 'warning', 'step': 'Step', 'description': 'Description'}]}], 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}]}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [{'key': 'Key', 'matching_results': 15, 'aggregations': []}], 'matching_results': 15, 'aggregations': [{'type': 'histogram', 'results': [], 'matching_results': 15, 'aggregations': [], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'field': 'Field', 'interval': 8}], 'passages': [{'document_id': 'DocumentId', 'passage_score': 12, 'passage_text': 'PassageText', 'start_offset': 11, 'end_offset': 9, 'field': 'Field'}], 'duplicates_removed': 17}";
        ...
        public void TestTestFederatedQueryAllParams()
        {
            ...
            string environmentId = "testString";
            string collectionIds = "testString";
            string filter = "testString";
            string query = "testString";
            string naturalLanguageQuery = "testString";
            bool? passages = true;
        ...
        public void TestTestCreateTrainingExampleAllParams()
        {
            ...
            string queryId = "testString";
            string documentId = "testString";
            string crossReference = "testString";
            long? relevance = 38;
        ...
        public void TestTestCreateEventAllParams()
        {
            ...
            var responseJson = "{'type': 'click', 'data': {'environment_id': 'EnvironmentId', 'session_token': 'SessionToken', 'client_timestamp': '2019-01-01T12:00:00', 'display_rank': 11, 'collection_id': 'CollectionId', 'document_id': 'DocumentId', 'query_id': 'QueryId'}}";
        ...
        public void TestTestGetMetricsQueryAllParams()
        {
            ...
            var responseJson = "{'aggregations': [{'interval': 'Interval', 'event_type': 'EventType', 'results': [{'key_as_string': '2019-01-01T12:00:00', 'key': 3, 'matching_results': 15, 'event_rate': 9}]}]}";
        ...
        public void TestTestCreateCredentialsAllParams()
        {
            ...
            string environmentId = "testString";
            string sourceType = "box";
            CredentialDetails credentialDetails = CredentialDetailsModel;
