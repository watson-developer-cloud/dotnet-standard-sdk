...
{
    /// <summary>
    /// Detects sharp and unexpected changes in the frequency of a facet or facet value over time based on the past
    /// history of frequency changes of the facet value.
    /// </summary>
    public class QueryAggregationQueryTrendAggregation : QueryAggregation
    {
        /// <summary>
        ...
        public new List<QueryTrendAggregationResult> Results { get; protected set; }
    }
