...
namespace IBM.Watson.LanguageTranslator.v3
{
    public partial class LanguageTranslatorService : IBMService, ILanguageTranslatorService
    {
        ...
        /// upload only a single forced glossary file for a model, and the size of the file must not exceed 10 MB.
        ...
        /// cumulative total of at least 5000 parallel sentences.
        ///
        ...
        ///
        /// The cumulative file size of all uploaded files for a custom model is limited to 250 MB. You can create a
        /// maximum of 10 custom models per language pair. For more information about customizing a translation model,
        ...
        /// upload multiple parallel corpus files in one request. All uploaded parallel corpus files combined must
        /// contain at least 5000 parallel sentences to train successfully. You can provide a maximum of 500,000
        /// parallel sentences across all corpora. A single entry in the corpus file can contain a maximum of 80 words.
        /// For more information, see **Supported file formats** in the method description.
        ///
