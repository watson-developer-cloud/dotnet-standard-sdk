...
namespace IBM.Watson.LanguageTranslator.v3.UnitTests
{
    ...
    public class LanguageTranslatorServiceUnitTests
    {
        ...
        public void TestTestListDocumentsAllParams()
        {
            ...
            var responseJson = "{'documents': [{'document_id': 'DocumentId', 'filename': 'Filename', 'status': 'processing', 'model_id': 'ModelId', 'base_model_id': 'BaseModelId', 'source': 'Source', 'target': 'Target', 'created': '2019-01-01T12:00:00', 'completed': '2019-01-01T12:00:00', 'word_count': 9, 'character_count': 14}]}";
        ...
        public void TestTestTranslateDocumentAllParams()
        {
            ...
            var responseJson = "{'document_id': 'DocumentId', 'filename': 'Filename', 'status': 'processing', 'model_id': 'ModelId', 'base_model_id': 'BaseModelId', 'source': 'Source', 'target': 'Target', 'created': '2019-01-01T12:00:00', 'completed': '2019-01-01T12:00:00', 'word_count': 9, 'character_count': 14}";
