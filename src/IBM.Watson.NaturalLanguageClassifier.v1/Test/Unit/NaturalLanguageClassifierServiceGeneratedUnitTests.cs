...
namespace IBM.Watson.NaturalLanguageClassifier.v1.UnitTests
{
    ...
    public class NaturalLanguageClassifierServiceUnitTests
    {
        ...
        public void TestTestCreateClassifierAllParams()
        {
            ...
            NaturalLanguageClassifierService service = new NaturalLanguageClassifierService(client);
            var responseJson = "{'name': 'Name', 'url': 'Url', 'status': 'Non Existent', 'classifier_id': 'ClassifierId', 'created': '2019-01-01T12:00:00', 'status_description': 'StatusDescription', 'language': 'Language'}";
        ...
        public void TestTestListClassifiersAllParams()
        {
            ...
            NaturalLanguageClassifierService service = new NaturalLanguageClassifierService(client);
            var responseJson = "{'classifiers': [{'name': 'Name', 'url': 'Url', 'status': 'Non Existent', 'classifier_id': 'ClassifierId', 'created': '2019-01-01T12:00:00', 'status_description': 'StatusDescription', 'language': 'Language'}]}";
