...
namespace IBM.Watson.NaturalLanguageUnderstanding.v1.UnitTests
{
    ...
    public class NaturalLanguageUnderstandingServiceUnitTests
    {
        ...
        public void TestTestListModelsAllParams()
        {
            ...
            var responseJson = "{'models': [{'status': 'Status', 'model_id': 'ModelId', 'language': 'Language', 'description': 'Description', 'workspace_id': 'WorkspaceId', 'version': 'Version', 'version_description': 'VersionDescription', 'created': '2019-01-01T12:00:00'}]}";
