[![NuGet](https://img.shields.io/badge/nuget-v2.16.0-green.svg?style=flat)](https://www.nuget.org/packages/IBM.Watson.PersonalityInsights.v3/)
...
PM > Install-Package IBM.Watson.PersonalityInsights.v3
...
<ItemGroup>
    <PackageReference Include="IBM.Watson.PersonalityInsights.v3" Version="2.16.0" />
</ItemGroup>
