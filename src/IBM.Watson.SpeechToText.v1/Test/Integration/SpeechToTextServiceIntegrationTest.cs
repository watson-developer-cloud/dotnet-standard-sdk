...
namespace IBM.Watson.SpeechToText.v1.IntegrationTests
{
    ...
    public class SpeechToTextServiceIntegrationTest
    {
        ...
        private string corpusPath = @"TestData/theJabberwocky-utf8.txt";
        ...
        private string testAudioPath = @"TestData/test-audio.wav";
        private string grammarName = "dotnet-sdk-grammars";
        private string grammarPath = @"TestData/confirm.abnf";
