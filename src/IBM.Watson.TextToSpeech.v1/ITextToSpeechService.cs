...
namespace IBM.Watson.TextToSpeech.v1
{
    public partial interface ITextToSpeechService
    {
        ...
        WebSocketClient SynthesizeUsingWebsockets(SynthesizeCallback callback, string text, string voice = null, string customizationId = null, string accept = null, string[] timings = null);
