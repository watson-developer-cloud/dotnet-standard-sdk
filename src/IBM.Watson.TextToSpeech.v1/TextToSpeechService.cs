...
namespace IBM.Watson.TextToSpeech.v1
{
    public partial class TextToSpeechService : IBMService, ITextToSpeechService
    {
        ...
        public class GetVoiceEnums
        {
            ...
            ///
            /// **IBM Cloud:** The Arabic, Chinese, Dutch, Australian English, and Korean languages and voices are
            /// supported only for IBM Cloud.
            /// </summary>
            public class VoiceValue
            {
                ...
                /// <summary>
                /// Constant EN_AU_CRAIGVOICE for en-AU-CraigVoice
                /// </summary>
                public const string EN_AU_CRAIGVOICE = "en-AU-CraigVoice";
                /// <summary>
                /// Constant EN_AU_MADISONVOICE for en-AU-MadisonVoice
                /// </summary>
                public const string EN_AU_MADISONVOICE = "en-AU-MadisonVoice";
                /// <summary>
        ...
        public class GetPronunciationEnums
        {
            ...
            /// same language (for example, `en-US`) return the same translation. For more information about specifying
            /// a voice, see **Important voice updates for IBM Cloud** in the method description.
            ///
            /// **IBM Cloud:** The Arabic, Chinese, Dutch, Australian English, and Korean languages and voices are
            /// supported only for IBM Cloud.
