...
namespace IBM.Watson.VisualRecognition.v3.Examples
{
    public class ServiceExample
    {
        ...
        private string localGiraffeFilePath = @"TestData/giraffe_to_classify.jpg";
        private string localFaceFilePath = @"TestData/obama.jpg";
        private string localGiraffePositiveExamplesFilePath = @"TestData/giraffe_positive_examples.zip";
        private string giraffeClassname = "giraffe";
        private string localTurtlePositiveExamplesFilePath = @"TestData/turtle_positive_examples.zip";
        private string turtleClassname = "turtle";
        private string localNegativeExamplesFilePath = @"TestData/negative_examples.zip";
