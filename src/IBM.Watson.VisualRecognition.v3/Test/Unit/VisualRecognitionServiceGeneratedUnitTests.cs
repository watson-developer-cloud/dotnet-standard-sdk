...
namespace IBM.Watson.VisualRecognition.v3.UnitTests
{
    ...
    public class VisualRecognitionServiceUnitTests
    {
        ...
        public void TestTestCreateClassifierAllParams()
        {
            ...
            var responseJson = "{'classifier_id': 'ClassifierId', 'name': 'Name', 'owner': 'Owner', 'status': 'ready', 'core_ml_enabled': false, 'explanation': 'Explanation', 'created': '2019-01-01T12:00:00', 'classes': [{'class': '_Class'}], 'retrained': '2019-01-01T12:00:00', 'updated': '2019-01-01T12:00:00'}";
        ...
        public void TestTestListClassifiersAllParams()
        {
            ...
            var responseJson = "{'classifiers': [{'classifier_id': 'ClassifierId', 'name': 'Name', 'owner': 'Owner', 'status': 'ready', 'core_ml_enabled': false, 'explanation': 'Explanation', 'created': '2019-01-01T12:00:00', 'classes': [{'class': '_Class'}], 'retrained': '2019-01-01T12:00:00', 'updated': '2019-01-01T12:00:00'}]}";
