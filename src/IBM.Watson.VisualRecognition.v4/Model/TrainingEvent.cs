...
namespace IBM.Watson.VisualRecognition.v4.Model
{
    ...
    public class TrainingEvent
    {
        ...
        /// <summary>
        /// Trained object type. Only `objects` is currently supported.
        /// Constants for possible values can be found using TrainingEvent.TypeEnumValue
        /// </summary>
        [JsonProperty("type", NullValueHandling = NullValueHandling.Ignore)]
        public string Type { get; set; }
        /// <summary>
        /// Training status of the training event.
        /// Constants for possible values can be found using TrainingEvent.StatusEnumValue
        /// </summary>
