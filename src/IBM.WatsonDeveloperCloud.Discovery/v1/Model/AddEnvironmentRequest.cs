...
namespace IBM.WatsonDeveloperCloud.Discovery.v1.Model
{
    ...
    public partial class AddEnvironmentRequest
    {
        /// <summary>
        /// Initializes a new instance of the AddEnvironmentRequest class.
        /// </summary>
        ...
        /// <param name="size">Size of the environment</param>
        public AddEnvironmentRequest(string name = default(string), string description = default(string), double? size = default(double?))
        {
            Name = name;
        ...
        /// <summary>
        /// Gets or sets size of the environment
        /// </summary>
