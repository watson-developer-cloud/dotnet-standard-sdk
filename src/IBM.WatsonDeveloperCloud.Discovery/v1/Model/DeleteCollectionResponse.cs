...
namespace IBM.WatsonDeveloperCloud.Discovery.v1.Model
{
    ...
    public partial class DeleteCollectionResponse
    {
        ...
        /// Initializes a new instance of the DeleteCollectionResponse class.
        /// </summary>
        public DeleteCollectionResponse(string collectionId)
        {
            CollectionId = collectionId;
        }
        /// <summary>
        /// Static constructor for DeleteCollectionResponse class.
        /// </summary>
        ...
        public virtual void Validate()
        {
            ...
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "CollectionId");
            }
        }
    }
}
