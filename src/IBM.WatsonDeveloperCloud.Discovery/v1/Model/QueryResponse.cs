...
namespace IBM.WatsonDeveloperCloud.Discovery.v1.Model
{
    ...
    public partial class QueryResponse
    {
        ...
        /// Initializes a new instance of the QueryResponse class.
        /// </summary>
        public QueryResponse(double? matchingResults = default(double?),List<QueryResult> results = default(System.Collections.Generic.IList<QueryResult>), QueryAggregation aggregations = default(QueryAggregation))
        {
