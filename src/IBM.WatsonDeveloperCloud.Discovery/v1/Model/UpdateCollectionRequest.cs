...
namespace IBM.WatsonDeveloperCloud.Discovery.v1.Model
{
    ...
    public partial class UpdateCollectionRequest
    {
        /// <summary>
        /// Initializes a new instance of the UpdateCollectionRequest class.
        /// </summary>
        ...
        /// the collection is to be updated</param>
        public UpdateCollectionRequest(string name, string description = default(string), string configurationId = default(string))
        {
            Name = name;
