...
namespace IBM.WatsonDeveloperCloud.PersonalityInsights.v3
{
    public interface IPersonalityInsightsService
    {
        ...
        Profile ProfileAsCsv(Content content, string contentType, string contentLanguage = null, string acceptLanguage = null, bool? rawScores = null, bool? csvHeaders = null, bool? consumptionPreferences = null);
    }
}
