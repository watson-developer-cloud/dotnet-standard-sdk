...
namespace IBM.WatsonDeveloperCloud.PersonalityInsights.v3
{
    public partial interface IPersonalityInsightsService
    {
        ...
        Profile Profile(Content content, string contentType, string contentLanguage = null, string acceptLanguage = null, bool? rawScores = null, bool? consumptionPreferences = null, bool? csvHeaders = null, Dictionary<string, object> customData = null);
        /// <summary>
        ...
        /// <param name="customData">Custom data object to pass data including custom request headers.</param>
        /// <returns><see cref="Profile" />Profile</returns>
        Profile ProfileAsCsv(Content content, string contentType, string contentLanguage = null, string acceptLanguage = null, bool? rawScores = null, bool? consumptionPreferences = null, bool? csvHeaders = null, Dictionary<string, object> customData = null);
    }
}
