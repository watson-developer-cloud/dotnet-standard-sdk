...
namespace IBM.WatsonDeveloperCloud.SpeechToText.v1
{
    public partial interface ISpeechToTextService
    {
        ...
        /// <returns><see cref="object" />object</returns>
        object AddAudio(string customizationId, string audioName, List<byte[]> audioResource, string contentType, string containedContentType = null, bool? allowOverwrite = null);
