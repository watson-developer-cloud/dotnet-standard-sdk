...
namespace IBM.WatsonDeveloperCloud.SpeechToText.v1.Model
{
    ...
    public class WordError : BaseModel
    {
        ...
        /// <value>
        /// A key-value pair that describes an error associated with the definition of a word in the words resource.
        /// Each pair has the format `"element": "message"`, where `element` is the aspect of the definition that caused
        ...
        /// try for example '{suggested_string}'."` You must correct the error before you can train the model.
        /// </value>
