...
namespace IBM.WatsonDeveloperCloud.TextToSpeech.v1.Model
{
    ...
    /// VoiceModel.
    /// </summary>
    public class VoiceModel : BaseModel
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The customization ID (GUID) of the custom voice model. The **Create a custom model** method returns only this field. It does not not return the other fields of this object.</value>
        ...
        /// </summary>
        /// <value>An array of `Word` objects that lists the words and their translations from the custom voice model. The words are listed in alphabetical order, with uppercase letters listed before lowercase letters. The array is empty if the custom model contains no words. This field is returned only by the **Get a voice** method and only when you specify the customization ID of a custom voice model.</value>
