...
{
    public partial class SupportedFeatures
    {
        /// <summary>
        /// Gets or sets if `true`, the voice can be customized; if `false`,
        /// the voice cannot be customized. (Same as `customizable`.)
        /// </summary>
        [JsonProperty(PropertyName = "custom_pronunciation")]
        public bool CustomPronunciation { get; set; }

        /// <summary>
        /// Gets or sets if `true`, the voice can be transformed by using the
        /// SSML `&amp;lt;voice-transformation&amp;gt;` element; if `false`,
        /// the voice cannot be transformed.
        /// </summary>
        [JsonProperty(PropertyName = "voice_transformation")]
