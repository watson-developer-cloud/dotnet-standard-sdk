...
namespace IBM.WatsonDeveloperCloud.VisualRecognition.v3
{
    public partial interface IVisualRecognitionService
    {
        ...
        Classifier CreateClassifier(string name, System.IO.Stream classnamePositiveExamples, System.IO.Stream negativeExamples = null, Dictionary<string, object> customData = null);
        /// <summary>
        /// Delete a classifier. 
        /// </summary>
        ...
        /// <param name="customData">Custom data object to pass data including custom request headers.</param>
        /// <returns><see cref="Classifier" />Classifier</returns>
        Classifier UpdateClassifier(string classifierId, System.IO.Stream classnamePositiveExamples = null, System.IO.Stream negativeExamples = null, Dictionary<string, object> customData = null);
        /// <summary>
        ...
        System.IO.Stream GetCoreMlModel(string classifierId, Dictionary<string, object> customData = null);
    }
}
