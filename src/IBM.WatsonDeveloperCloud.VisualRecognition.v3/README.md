[![NuGet](https://img.shields.io/badge/nuget-v2.3.0-green.svg?style=flat)](https://www.nuget.org/packages/IBM.WatsonDeveloperCloud.VisualRecognition.v3/)
...
<ItemGroup>
    <PackageReference Include="IBM.WatsonDeveloperCloud.VisualRecognition.v3" Version="2.3.0" />
</ItemGroup>
