[![NuGet](https://img.shields.io/badge/nuget-v2.0.0-green.svg?style=flat)](https://www.nuget.org/packages/IBM.WatsonDeveloperCloud.VisualRecognition.v3/)
...
"dependencies": {
   "IBM.WatsonDeveloperCloud.VisualRecognition.v3": "2.0.0"
}
