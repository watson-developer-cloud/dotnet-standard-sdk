...
namespace IBM.WatsonDeveloperCloud.VisualRecognition.v3
{
    public partial class VisualRecognitionService : WatsonService, IVisualRecognitionService
    {
        ...
        /// and class names). The service assumes UTF-8 encoding if it encounters non-ASCII characters.returnFields
        /// </summary>
        ...
        /// last time the classifier retraining finished.returnFields
        /// </summary>
        /// <param name="classifierId">The ID of the classifier.</param>
        /// <param name="classnamePositiveExamples">A .zip file of images that depict the visual subject of a class in
        ...
        /// true</tt> in the classifier details.returnFields
        /// </summary>
        /// <param name="classifierId">The ID of the classifier.</param>
        /// <param name="customData">Custom data object to pass data including custom request headers.</param>
