...
namespace IBM.WatsonDeveloperCloud.SpeechToText.UnitTest
{
    ...
    public class SpeechToTextServiceUnitTest
    {
        ...
        public void CreateCustomModel_Success()
        {
            ...
            var result =
                service.CreateCustomModel(CustomModelOptions.Builder
                                                            .WithName("custom_model_name")
                                                            .WithBaseModel("base_model_id")
        ...
        [TestMethod, ExpectedException(typeof(ArgumentNullException))]
        public void CreateCustomModel_With_Name_Empty()
        {
            #region Mock IClient
        ...
        [TestMethod, ExpectedException(typeof(ArgumentNullException))]
        public void CreateCustomModel_With_BasModelName_Empty()
        {
            #region Mock IClient
